...
with torch.autograd.no_grad():
    ...
    run_eval(image_dir= 'E:/Deep_learning_Final/dataset/images/data', anno_file = 'E:/Deep_learning_Final/dataset/annotations/annotation.json', vis_dir = 'E:/Deep_learning_Final/dataset/images/vis_data', model=model, preprocess='vgg')
